...
export default function HomeComponentVolunteerSupport() {
  return (
    <section className="relative w-full py-14 md:py-24 px-3 bg-gradient-to-br from-pink-50 via-indigo-50 to-emerald-50 flex flex-col items-center overflow-hidden">
      ...
      {/* Buttons "platform" with soft glass background */}
      <motion.div
      ...
      >
        ...
        >
          <Link
            ...
            className="group relative flex items-center gap-2 px-8 py-3 rounded-xl font-bold bg-gradient-to-r from-fuchsia-500 to-pink-400 text-white shadow-md border-2 border-fuchsia-200 focus:outline-none focus:ring-4 focus:ring-fuchsia-100 text-base md:text-lg
             hover:from-pink-400 hover:to-fuchsia-500 hover:border-fuchsia-400 transition-all duration-200"
            style={{ minWidth: 140, textAlign: "center" }}
          >
            <FaUserPlus className="text-lg md:text-xl opacity-80" />
            Volunteer
            {/* Glassy animated glow */}
        ...
        >
          <Link
            ...
            className="group relative flex items-center gap-2 px-8 py-3 rounded-xl font-bold bg-gradient-to-r from-cyan-500 to-emerald-400 text-white shadow-md border-2 border-emerald-200 focus:outline-none focus:ring-4 focus:ring-emerald-100 text-base md:text-lg
              hover:from-emerald-400 hover:to-cyan-500 hover:border-emerald-400 transition-all duration-200"
      ...
      {/* Decorative wavy full-width bottom border */}
      <svg viewBox="0 0 1440 150" className="absolute left-0 bottom-0 w-full h-20 md:h-32 z-0" preserveAspectRatio="none" aria-hidden="true">
        <defs>
