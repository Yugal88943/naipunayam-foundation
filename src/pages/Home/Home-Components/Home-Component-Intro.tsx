...
//   type BubbleProps = { size: number; className: string; color: string };
//   const Bubble: React.FC<BubbleProps> = ({ size, className, color }) => (
//     <motion.div
...
//   // Subtitle and section change timing
//   useEffect(() => {
...
//         >
//           <span className={`bg-clip-text ${style.titleGradient} text-transparent block pb-1 leading-[1.2]`}> {title} </span>
//           {/* Divider */}
...
//           whileHover={{ scale: 1.1, background: `linear-gradient(90deg, ${style.hoverGradient})`, boxShadow: '0px 0px 20px rgba(255,255,255,0.3)' }}
