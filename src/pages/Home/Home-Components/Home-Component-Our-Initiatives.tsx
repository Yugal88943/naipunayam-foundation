...
// import hansaz from '../../../assets/Home-Section/Home-Section-OurInitiatives-HansaZ.jpg';

// const INITIATIVES = [
//   {
//     link: "/OurInitiatives/Vihaas-Design-Technologies",
//     image: vihaasDesign,
...
//   },
//   {
//     link: "/OurInitiatives/Vihaas-Tech-Pro",
//     image: vihaasTech,
//     alt: "Vihaas Tech Pro",
...
// // Much smoother, slower, gentle cubic bezier curve
...
//         {/* Animated, high-contrast gradient vertical timeline line */}
//         <div
//           className="
//             absolute left-1/2 top-0 bottom-0 w-2 z-0 rounded-full
...
//                 duration: 1.2,
//                 delay: idx * 0.19,
//                 ease: [0.16, 1, 0.29, 0.99], // super smooth cubic
//               }}
//             >
//               {/* Timeline marker with animated pulse on hover */}
...
//                     ring-0
//                     ${hovered === idx ? "animate-timeline-pulse" : ""}
//                   `}
//                 >
...
//                   y: -8,
//                   scale: 1.03,
//                   boxShadow: "0 8px 40px 0 #e879f97a, 0 1.5px 12px 0 #8b5cf633"
//                 }}
//                 animate={{
//                   y: hovered === idx ? -6 : 0
//                 }}
...
//         </div>
//       </div>
//       {/* CSS for animated timeline gradient and pulse */}
//       <style>{`
