...
//   visible: { opacity: 1, y: 0, scale: 1, transition: { duration: 0.7, type: "spring", bounce: 0.3 } },
// };
...
//         <h1 className="relative text-2xl md:text-3xl font-extrabold text-white px-10 py-4 tracking-wide z-10 shadow-md select-none">
//           Driving Sustainable Impact Together
//         </h1>
//       </div>

//       {/* Glass Card - Why Partner */}
//       <motion.div
//         className="max-w-2xl mx-auto bg-white/30 border border-white/40 shadow-2xl backdrop-blur-lg rounded-3xl px-8 py-10 mb-10 text-center relative overflow-hidden"
//         initial="hidden"
//         whileInView="visible"
...
//         <h2 className="text-2xl font-bold mb-3 bg-gradient-to-r from-blue-500 via-indigo-500 to-green-400 bg-clip-text text-transparent">
//           Why Partner with Us?
//         </h2>
//         <p className="mb-5 text-gray-700 font-medium text-justify">
//           At Naipunayam Foundation, collective action fuels real change. Join our movement dedicated to education, skill development, and sustainable growth—where every partnership is a catalyst for impact.
//         </p>
       
//        <ul className="flex flex-col gap-1 items-start text-base font-semibold text-blue-900/90 mb-1">
//   <motion.li whileHover={{ scale: 1.08 }} className="grid grid-cols-[auto,1fr] gap-2 items-start text-left">
//     <span className="text-green-500 text-lg">✔️</span>
//     Access to Community Outreach Programs
//   </motion.li>
//   <motion.li whileHover={{ scale: 1.08 }} className="grid grid-cols-[auto,1fr] gap-2 items-start text-left">
...
//         <motion.div
//           className="bg-gradient-to-tr from-white/90 via-blue-50/50 to-blue-100/50 rounded-2xl shadow-lg border border-white/70 flex flex-col items-center p-7 hover:scale-105 transition-transform duration-300 relative overflow-hidden"
//           initial="hidden"
//           whileInView="visible"
//           viewport={{ once: true, amount: 0.7 }}
//           variants={cardVariants}
//         >
//           <motion.div
//             className="mb-2 p-3 rounded-full bg-blue-50 shadow-inner"
...
//           </p>
//           <div className="absolute -bottom-2 -left-3 w-24 h-12 bg-gradient-to-br from-blue-300/20 via-indigo-300/20 to-transparent blur-lg rounded-full" />
//         </motion.div>
//         <motion.div
//           className="bg-gradient-to-tl from-white/90 via-green-50/50 to-green-100/60 rounded-2xl shadow-lg border border-white/70 flex flex-col items-center p-7 hover:scale-105 transition-transform duration-300 relative overflow-hidden"
//           initial="hidden"
//           whileInView="visible"
//           viewport={{ once: true, amount: 0.7 }}
//           variants={cardVariants}
//         >
//           <motion.div
//             className="mb-2 p-3 rounded-full bg-green-50 shadow-inner"
//             whileHover={{ rotate: -6, scale: 1.17 }}
//           >
//             <FaGlobe className="text-4xl text-green-700" />
//           </motion.div>
...
//           </p>
//           <div className="absolute -bottom-2 -right-3 w-24 h-12 bg-gradient-to-br from-green-300/20 via-blue-300/10 to-transparent blur-lg rounded-full" />
//         </motion.div>
//       </div>
...
//         <Link
//           to="/contact-us"
//           className="inline-block px-8 py-3 rounded-full bg-gradient-to-r from-blue-600 via-indigo-500 to-green-400 text-white font-bold shadow-lg hover:scale-105 hover:from-green-400 hover:to-blue-700 transition relative overflow-hidden"
//         >
...
//             style={{
//               background:
//                 "linear-gradient(100deg, transparent 60%, #fff9 85%, transparent 95%)",
//               opacity: 0.22,
//             }}
//           />
//         </Link>
