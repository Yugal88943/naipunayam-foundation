...
//         >
//           <p className="text-lg text-gray-800 mb-3 text-justify">
//             <strong>Our vision</strong> is to help Himachal’s youth become <strong>self-reliant</strong> by building in-demand skills and career confidence. If you or someone you know is interested in starting a new career or building hands-on expertise, this is the perfect place to begin.
//           </p>
//           <div className="text-green-800 font-semibold">Let’s build the future together!</div>
//         </motion.div>
//       </div>
...
const BlogNewsDetailSolderingTraining: React.FC = () => {
  ...
  return (
    <section className="min-h-screen w-full bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      ...
      {/* Main Container */}
      <div className="max-w-4xl mx-auto bg-gray-50 rounded-3xl shadow-xl p-6 sm:p-10 space-y-10 transition duration-300 hover:shadow-2xl">
        {/* HERO Block */}
        <motion.div
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.6 }}
          variants={fadeFromLeft}
          className="bg-green-50 rounded-3xl shadow-lg p-6 md:p-10 flex flex-col md:flex-row items-center gap-8 transition duration-300 hover:bg-green-100"
        >
          <img
            src={Blog_Vihaas_Design_3}
            alt="Soldering training"
          ...
          />
          <div className="flex-1">
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-green-800 mb-2 hover:text-green-900 transition">
              Free Soldering Training for Youth – Learn, Build, Empower!
            </h1>
            <div className="text-green-600 uppercase text-xs font-semibold mb-3 tracking-wider">
              Skill Development Initiative
            </div>
            <p className="text-base sm:text-lg text-gray-700 text-justify hover:text-gray-800 transition">
              The Naipunayam Foundation proudly announces a <span className="font-bold text-green-700">100% free soldering training program</span> for youth in Solan, Himachal Pradesh. This hands-on course is designed for anyone interested in practical skills—no previous experience required!
            </p>
          </div>
        </motion.div>
        ...
        <div className="flex flex-col md:flex-row gap-8">
          <motion.div
            ...
            viewport={{ once: true, amount: 0.5 }}
            variants={fadeFromBottom}
            className="bg-blue-50 rounded-2xl p-6 shadow w-full transition duration-300 hover:bg-blue-100"
          >
            <h3 className="font-semibold text-blue-700 mb-3 text-lg flex items-center gap-2">
              <FaCheckCircle className="text-blue-500" /> Program Highlights
            </h3>
            <ul className="list-disc pl-5 space-y-2 text-gray-800 text-base text-justify">
              <li className="hover:text-blue-600 transition">Free training—no costs for learners</li>
              <li className="hover:text-blue-600 transition">Monthly stipend to support attendance</li>
              <li className="hover:text-blue-600 transition">Practical, real-world soldering techniques</li>
              <li className="hover:text-blue-600 transition">Supportive mentorship in an empowering environment</li>
            </ul>
          </motion.div>
          ...
          <motion.div
            ...
            viewport={{ once: true, amount: 0.5 }}
            variants={fadeFromRight}
            className="bg-yellow-50 rounded-2xl p-6 shadow w-full flex items-center transition duration-300 hover:bg-yellow-100"
          >
            <img
              src={Blog_Vihaas_Design_4}
              alt="Mentor assisting student in soldering"
            ...
            />
            <div>
              <h3 className="font-semibold text-yellow-700 mb-2 text-lg flex items-center gap-2 hover:text-yellow-800 transition">
                <FaTools className="text-yellow-600" /> Who Can Join?
              </h3>
              <p className="text-base text-gray-700 text-center hover:text-gray-800 transition">
                Any young person looking to learn and grow—no technical background necessary, just curiosity and commitment.
              </p>
            </div>
          </motion.div>
        ...
        <motion.div
          ...
          viewport={{ once: true, amount: 0.6 }}
          variants={fadeFromLeft}
          className="bg-gray-50 rounded-2xl shadow-md p-6 transition duration-300 hover:bg-gray-100"
        >
          <p className="text-lg text-gray-800 mb-3 text-justify hover:text-gray-900 transition">
            <strong>Our vision</strong> is to help Himachal’s youth become <strong>self-reliant</strong> by building in-demand skills and career confidence. If you or someone you know is interested in starting a new career or building hands-on expertise, this is the perfect place to begin.
          </p>
          <div className="text-green-800 font-semibold hover:text-green-900 transition">Let’s build the future together!</div>
        </motion.div>
      </div>
    </section>
  );
