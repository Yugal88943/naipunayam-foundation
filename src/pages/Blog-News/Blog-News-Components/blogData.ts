...
export const blogPosts = [
  ...
  },
  {
    ...
    snippet:
      "Vihaas Design Technologies, based in Solan, is driving local innovation in telecommunications and product design. Their commitment to 'Make in India' supports job creation, skill-building, and a brighter future for Himachal’s youth.",
  ...
  },
  {
    ...
    snippet:
      "Naipunayam Foundation now offers free, hands-on soldering training in Solan—open to all youth, with a monthly stipend and mentorship. No experience required—just enthusiasm to learn!",
  ...
  },
  {
    ...
    snippet:
      "Bridging the gap between classroom theory and practical innovation, Vihaas Tech Pro is shaping the next generation of Himachal’s technical talent through mentorship, project-based learning, and hands-on industry experience.",
  ...
  },
  {
    ...
    snippet:
      "Discover how Vihaas Tech Pro empowers students to master Embedded Systems, IoT, and Hardware Design through immersive, hands-on programs built in collaboration with industry experts.",
