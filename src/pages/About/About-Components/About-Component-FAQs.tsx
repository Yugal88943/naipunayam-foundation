          ...
          >
            ...
            <motion.button
              ...
              className={`
                ...
                rounded-2xl rounded-br-sm px-5 py-3 shadow-xl my-2
                transition-all
            ...
            <AnimatePresence>
              {openIdx === i && (
                <motion.div
                  ...
                  className={`
                    flex items-end self-start gap-3 max-w-[93%] sm:max-w-[77%] md:max-w-[68%]
                    my-2 bg-white/80 backdrop-bl-lg border border-cyan-100
                    text-gray-800 rounded-2xl rounded-bl-sm px-5 py-4 shadow-lg
                    font-medium
                  `}
                >
