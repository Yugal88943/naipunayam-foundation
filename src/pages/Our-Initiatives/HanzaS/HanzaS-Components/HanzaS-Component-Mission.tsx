...
//       <div className="relative max-w-6xl w-full rounded-2xl overflow-hidden shadow-2xl group z-10">
//         <img
//           src={hanzaSMission}
//           alt="HanzaS Mission"
...
//           <motion.div
//             className="bg-white/20 backdrop-blur-md rounded-xl p-6 sm:p-10 text-white text-center max-w-3xl shadow-lg border border-white/30 opacity-90 group-hover:opacity-100 transition-opacity duration-500"
//             initial={{ opacity: 0, scale: 0.95 }}
//             whileInView={{ opacity: 1, scale: 1 }}
//             viewport={{ once: false, amount: 0.5 }}
//             transition={{ duration: 0.8 }}
//           >
//             <h2 className="text-3xl sm:text-4xl font-bold font-serif mb-4 drop-shadow-lg">
//               Our Mission
//             </h2>
//             <p className="text-sm sm:text-base md:text-lg leading-relaxed text-gray-100 drop-shadow-sm">
//             <b> At HanzaS, we are dedicated to sustainable fashion and craftsmanship, offering a wide range
// of eco-friendly and organic materials like raw silk, banana silk, lotus silk, Pashmina, hemp,
// and handwoven cotton. Our collections are elevated with traditional handwork techniques
// such as Kantha, Phulkari, Bandhani, Ikat, Kalamkari, and more.
// </b> </p>
// <p className="text-sm sm:text-base md:text-lg leading-relaxed text-gray-100 drop-shadow-sm">
// <b>
// Beyond textiles, we celebrate India’s rich artisanal heritage through a curated selection of
// handcrafted home decor, jewelry, pottery, metalwork, wood and stone carvings, and
// bamboo crafts. Each piece is a reflection of cultural tradition, sustainability, and the skilled
// hands of local artisans—bringing authenticity and elegance to your wardrobe and home.
