...
//       className="sticky top-0 z-50 bg-white/80 text-black backdrop-blur-md shadow-md w-full scroll-smooth"
//     >
//       <div className="max-w-[1440px] mx-auto w-full flex items-center justify-between px-4 py-3">
//         {/* Logo + Title block */}
//         <motion.a
//           href="/"
//           className="flex items-center space-x-3 min-w-0 flex-shrink transition-transform duration-300 ease-in-out hover:scale-105 hover:drop-shadow-xl"
...
//                 <Link
//                   to={item.href}
//                   className="text-gray-800 hover:text-blue-600 transition duration-300 ease-in-out transform hover:scale-110 hover:-translate-y-1 hover:drop-shadow-xl hover:backdrop-blur-sm"
//                   onClick={closeMenu}
//                 >
//                   {item.name}
//                 </Link>
...
//           <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-pink-600 text-lg transition-transform duration-200 ease-in-out hover:scale-110"><FaInstagram /></a>
//           <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-blue-500 text-lg transition-transform duration-200 ease-in-out hover:scale-110"><FaFacebookF /></a>
//           <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-blue-400 text-lg transition-transform duration-200 ease-in-out hover:scale-110"><FaLinkedinIn /></a>
//           <Link
//             to="/contact-us"
...
//               <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-pink-600 text-lg"><FaInstagram /></a>
//               <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-blue-500 text-lg"><FaFacebookF /></a>
...
export default function Header() {
  ...
  return (
    ...
    >
      <div className="max-w-[1440px] mx-auto w-full flex items-center justify-between px-4 py-3">
        {/* ✅ Fixed: Logo using Link to prevent reload */}
        ...
        {/* Contact + Social Icons (desktop only) */}
        <div className="hidden xl:flex items-center space-x-4">
          <a href="https://www.instagram.com/naipunayam/" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-pink-600 text-lg transition-transform duration-200 ease-in-out hover:scale-110"><FaInstagram /></a>
          <a href="https://www.facebook.com/naipunayam" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-blue-500 text-lg transition-transform duration-200 ease-in-out hover:scale-110"><FaFacebookF /></a>
          <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-blue-400 text-lg transition-transform duration-200 ease-in-out hover:scale-110"><FaLinkedinIn /></a>
          <Link
            to="/contact-us"
            className="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2 rounded-md font-semibold text-sm transition-transform duration-200 hover:scale-110 shadow-lg"
        ...
        {isOpen && (
          ...
          >
            ...
            <div className="flex justify-center space-x-6 mt-4">
              {/* <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-pink-600 text-lg"><FaInstagram /></a> */}
              <a
  href="https://www.instagram.com/naipunayam/"
  target="_blank"
